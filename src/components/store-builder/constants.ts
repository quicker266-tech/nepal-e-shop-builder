...
export const SECTION_DEFINITIONS: Record<SectionType, SectionDefinition> = {
  ...
  product_filters: {
    ...
    icon: 'Filter',
    category: 'products',
    description: 'Sidebar filters for price, category, and attributes',
    defaultConfig: {
  ...
  product_sort: {
    ...
    defaultConfig: {
      options: ['price_asc', 'price_desc', 'name_asc', 'newest', 'popular'],
      defaultSort: 'newest',
    },
  },
  recently_viewed: {
    ...
    icon: 'History',
    category: 'products',
    description: 'Show products the customer recently viewed',
    defaultConfig: {
